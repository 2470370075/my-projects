...
# 页码信息也在下部分响应数据中藏着，
# 开始只下载第一页，得到页码信息后重新返回self.parse进行所有分页的数据下载
...
class JiushiguangSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for i in range(1,page+1):
            url = 'https://weibo.com/u/7202419272?is_search=0/&visible=0&is_all=1&is_tag=0&profile_ftype=1&page={}#feedtop'.format(i)
            request = Request(url,
                              self.img,
        ...
        for i in range(2):
            url = """https://weibo.com/p/aj/v6/mblog/mbloglist?ajwvr=6&domain=100505&is_search=0&visible=0&is_all=1&is_tag=0&profile_ftype=1&page=1&pagebar={}&pl_name=Pl_Official_MyProfileFeed__20&id=1005057202419272&script_uri=/u/7202419272&feed_type=0&pre_page=1&domain_op=100505&__rnd=1585660902336""".format(i)
